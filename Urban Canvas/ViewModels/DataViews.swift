...
var oeuvres : [StreetArts] = [
    StreetArts(name: "Liberté Egalité Fraternité", image: "liberte-egalite-fraternite", type: ["Calligraphie", "Mural"], date: "Avril 2025", description: """
    ...
    StreetArts(name: "La Joconde de Marseille", image: "joconde-marseille", type: ["Harlftone", "Mural"], date: "Mars 2022", description: "Dans le cadre de l'exposition \" La Joconde, exposition immersive \" au Palais de la Bourse à Marseille, coproduite par le Grand Palais Immersif et le Musée du Louvre, le MauMA : Musée des arts urbains de Marseille a donné \" carte blanche \" à l'artiste Kan / DMV pour la réalisation de l'oeuvre \" La Joconde de Marseille \". Produite et coordonée par Méta 2, elle est la première représentation urbaine de la célèbre Monna Lisa au sein de la cité phocéenne.", artist: "KAN DMV" , city: "Marseille", localization: "Palais de la Bourse, 13001 Marseille", condition: "Bonne", longitude: 5.3756, latitude: 43.2965),
    ...
    StreetArts(name: "Chuuut...", image: "chuuut", type: ["Street art figuratif", "Stencil"], date: "Janvier 2011", description: """
